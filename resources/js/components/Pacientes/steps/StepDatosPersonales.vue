...
<template>
  <section class="space-y-4">
    <h2 class="text-lg font-medium">Paso 1: Datos personales</h2>

    <div class="grid grid-cols-1 gap-4 md:grid-cols-3">
      <label class="form-control">
        <span class="label-text">Nombre(s) *</span>
        <input v-model="form.nombre" type="text" class="input input-bordered w-full" maxlength="255" required>
      </label>
      <label class="form-control">
        <span class="label-text">Apellido paterno *</span>
        <input v-model="form.apellidoPaterno" type="text" class="input input-bordered w-full" maxlength="255" required>
      </label>
      <label class="form-control">
        <span class="label-text">Apellido materno</span>
        <input v-model="form.apellidoMaterno" type="text" class="input input-bordered w-full" maxlength="255">
      </label>

      <label class="form-control">
        <span class="label-text">Fecha de nacimiento *</span>
        <input v-model="form.fechaNacimiento" type="date" class="input input-bordered w-full" required>
      </label>
      <label class="form-control">
        <span class="label-text">Sexo *</span>
        <select v-model="form.sexo" class="select select-bordered w-full" required>
      ...
      <label class="form-control">
        ...
        <input v-model="form.telefono" type="tel" class="input input-bordered w-full" maxlength="10" pattern="[0-9]{10}" required>
      </label>
      <label class="form-control">
        <span class="label-text">Correo electrónico</span>
        <input v-model="form.correo" type="email" class="input input-bordered w-full" maxlength="255">
      </label>

      <label class="form-control">
        <span class="label-text">Estado</span>
        <input v-model="form.estado" type="text" class="input input-bordered w-full" maxlength="255">
      </label>
      <label class="form-control">
        <span class="label-text">Municipio</span>
        <input v-model="form.municipio" type="text" class="input input-bordered w-full" maxlength="255">
      </label>
      <label class="form-control md:col-span-3">
        <span class="label-text">Dirección completa</span>
        <input v-model="form.direccion" type="text" class="input input-bordered w-full" maxlength="255">
      </label>
