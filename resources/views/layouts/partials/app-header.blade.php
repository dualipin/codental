    ...
    <div class="flex-none flex items-center gap-1">
        ...
        <div class="dropdown dropdown-end">
            ...
            <ul tabindex="0" class="dropdown-content menu bg-base-100 rounded-box z-1 w-52 p-2 shadow-lg">
                <li><a href="{{ route('usuarios.profile', ['user' => auth()->user()->id]) }}"><i class="bi bi-person"></i> Perfil</a></li>
                <li><a><i class="bi bi-gear"></i> Configuración</a></li>
                <li><a class="text-error"><i class="bi bi-box-arrow-right"></i> Cerrar sesión</a></li>
            </ul>
        </div>
    </div>
</header>
